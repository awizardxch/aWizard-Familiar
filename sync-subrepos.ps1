...
$Repos = [ordered]@{
    "forge-puzzles" = @{
        Root        = $ForgeRoot
        Description = "Forge's on-chain code: the V12 pool on CHIP-0050, the lock, and every suite that runs them."
        ...
        Slices      = @(
            ...
            @{ From = "projects\chia-cfmm\contracts"; To = "contracts"
               Except = @("greenwood", "development", "v11")
               ExceptFiles = @("_test_v11_*.py") }
            @{ From = "projects\chia-cfmm\docs\FORGE_PUZZLE_V12.md";      To = "docs\FORGE_PUZZLE_V12.md" }
            ...
            @{ From = "projects\chia-cfmm\scripts\mutate-v12.py"; To = "scripts\mutate-v12.py" }
            @{ From = "projects\chia-cfmm\scripts\build-v12.py";  To = "scripts\build-v12.py" }
